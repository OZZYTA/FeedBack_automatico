...
public class EmployeeEfficiencyDtoResponse {
    ...
    public EmployeeEfficiencyDtoResponse(Long employeeId, String employeeEmail, double averageTimeInMinutes, Integer totalOrders) {
